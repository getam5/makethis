...
import com.spring.myapp.imscalr.MediaUtils;
import com.spring.myapp.imscalr.UploadFileUtils;

 // 빈이 왜 주입이 안됨?????? 이해가안되는 상황
@Controller
@RequestMapping("/sample/upload/*")
public class UploadController {

	private static final Logger logger = LoggerFactory.getLogger(UploadController.class);
// uploadPath가 존재하지않는거,, Resource를 못먹이는거지........... 답이없네.......
